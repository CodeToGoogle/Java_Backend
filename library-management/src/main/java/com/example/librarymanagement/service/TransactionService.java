...
public class TransactionService {
    ...
    public TransactionResponse issueTxn(String bookName, int studentId) throws Exception {
        ...
        try {
            ...
            return new TransactionResponse(book.getId(),transaction.getExternalTxnId());
        }
    }
